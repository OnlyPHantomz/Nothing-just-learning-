...
* `$message`: `string` 
eProto\ParseMode` Text parse mode for the caption  
* `$callback`: `?
...
* `$file`: `(\danog\o disable forwards for this message.  
...
: Indicates a parsing mode for text.](../../../../../danog/MadelineProto/ParseMode.html)
* `\Amp\Cancellation`
